...
""" hexinMQTTClient """
# !/usr/bin/python
# Python:   Pycom MicroPython 1.18.0.r1
# Platform: ESP32
# Author:   Heyn (heyunhuan@gmail.com)
# Program:  hexinMQTTClient.
# History:  2018/09/03 V1.0 [Heyn] Initialization.

import umqtt.MQTTConst as mqttConst
import umqtt.MQTTMsgHandler as msgHandler
import time
import struct
import _thread
...
class hexinMQTTClient:

    def __init__(self, clientID, cleanSession=True, protocol=mqttConst.MQTTv3_1_1):
    ...
    def configUserPassWord(self, username, password):
        self._user = username
    ...
    def setMQTTReceiveTimeoutMilliSecond(self, srcMQTTReceiveTimeout=3000):
        self._msgHandler.setReceiveTimeout(srcMQTTReceiveTimeout)
    ...
    def publish(self, topic, payload, qos=0, retain=False, dup=False):
        topic = topic.encode('utf-8')
